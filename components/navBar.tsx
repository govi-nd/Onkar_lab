  ...
  return (
    <div className="h-16 w-full border-b border-gray-200 flex items-center px-8 justify-around">
      ...
      <div className="flex items-center gap-8 text-lg font-medium ">
        ...
        <Link href="/" className="text-gray-600 hover:text-[#0d6efd] hover:translate-y-1 transition duration-300">Home</Link>
        <Link href="/tests" className="text-gray-600 hover:text-[#0d6efd] hover:translate-y-1 transition duration-300 ">Tests</Link>
        <Link href="/book" className="text-gray-600 hover:text-[#0d6efd] hover:translate-y-1 transition duration-300">Book Appointment</Link>
        <Link href="/contact" className="text-gray-600 hover:text-[#0d6efd] hover:translate-y-1 transition duration-300">Contact</Link>
      </div>
